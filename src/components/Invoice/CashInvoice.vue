      ...
      <div class="paper-container shadow border overflow-hidden sm:rounded-md">
        <div class="px-4 py-5 bg-white sm:p-6">
          <div class="container px-5">
            ...
            <div class="row">
              <div class="col-6">
                <p class="font-sm-3 m-0"><strong>Nomor Faktur</strong> : <span class="font-blue">{{ convertDate(dataInvoice.cash_tgl) + '/' + dataInvoice.kode_cash }}</span> </p>
              ...
              <section class="container-invoice">
                ...
                <div class="right-side">
                  ...
                  <div class="item">
                    <p>{{ convertDateString(dataInvoice.cash_tgl) }}</p>
                  </div>
                  <div class="item">
              ...
              <section class="container-invoice">
                ...
                <div class="right-side">
                  ...
                  <div class="item">
                    {{ 'Rp. ' + dataInvoice.cash_bayar }}
                  </div>
                  <div class="item">
                    Rp. {{ parseInt(dataInvoice.cash_bayar) - parseInt(dataInvoice.harga_mobil) }}
                  </div>
                </div>
              </section>
...
export default {
  ...
  methods: {
    getInvoiceCash(id) {
      fetch('http://localhost:8000/api/invoice/cash/' + id)
      .then(response => response.json())
      .then(result => {
        this.dataInvoice = result;
        console.info(this.dataInvoice);
        this.$parent.showInvoice('cash');
      })
      .catch(error => {
