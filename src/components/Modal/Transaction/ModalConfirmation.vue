            ...
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
              <div class="sm:flex sm:items-start">
                ...
                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                  <h2 class="text-lg text-red-600">Pastikan data sudah benar !!</h2>
                  <table>
                    <tr>
                      <td>Pembeli</td>
                      <td class="px-2">:</td>
                      <td>{{ data.selectedCustomer.nama_pembeli }}</td>
                    </tr>
                    <tr>
                      <td>Merk Mobil</td>
                      <td class="px-2">:</td>
                      <td>{{ data.selectedCar.merk }}</td>
                    </tr>
                    <tr>
                      <td>Nominal Uang</td>
                      <td class="px-2">:</td>
                      <td v-if="data.payment.credit.uang_muka != ''">{{ data.payment.credit.uang_muka }}</td>
                      <td v-else>{{ data.payment.cash.cash_bayar }}</td>
                    </tr>
                  </table>
                </div>
              </div>
