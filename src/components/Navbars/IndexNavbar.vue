...
<template>
  <Popover class="sticky z-10 top-0 bg-white shadow">
    <div class="max-w-7xl mx-auto px-4 sm:px-6">
      <div class="flex justify-between items-center md:justify-start md:space-x-10">
        <div class="flex justify-start lg:w-0 lg:flex-1 py-3">
          <a href="#">
            <span class="logo-style text-emerald text-2xl">CarStore</span>
          </a>
        </div>
        ...
        <div class="hidden md:flex">
          <router-link to="/" class="nav-link py-5 px-3 text-base font-medium text-gray-700 hover:text-gray-900">
            Home
          </router-link>
          <router-link to="/store" class="nav-link py-5 px-3 text-base font-medium text-gray-700 hover:text-gray-900">
            Store
          </router-link>
        ...
        <div class="hidden md:flex items-center justify-end md:flex-1 lg:w-0 py-3">
          ...
          <a href="#" class="whitespace-nowrap text-base font-medium text-gray-700 hover:text-emerald-500">
            Sign in
          </a>
          <a href="#" class="ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-emerald-500 hover:bg-emerald-600 hover:text-white">
            Sign up
          </a>
        </div>
      </div>
      ...
      <PopoverPanel focus class="absolute top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden">
        <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
          ...
          <div class="py-6 px-5 space-y-6">
            ...
            <div>
              <a href="#" class="w-full flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-emerald-500 hover:bg-emerald-600">
                Sign up
              </a>
